...
- **Emit** to IEC §3 Structured Text or PLCopen TC6 v2.01 XML.  Output is XSD-validated; matiec round-trip passes 49/49 cases (47 single-emit + 2 end-to-end emit→parse_program→re-emit), rusty 29/38 (with 9 xfailed tracking rusty-side stdlib divergences).
